...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView, @NonNull CardView ivLogo,
      @NonNull ConstraintLayout logoContainer, @NonNull TextView tvAppName,
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.ivLogo;
      CardView ivLogo = ViewBindings.findChildViewById(rootView, id);
      if (ivLogo == null) {
        break missingId;
      }
